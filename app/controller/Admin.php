...
class Admin extends Base
{
    ...
    public function admin(){
        ...
        'magic_quotes_gpc'  =>  ("1"===get_cfg_var('magic_quotes_gpc'))?'YES':'NO',

        // 'magic_quotes_runtime'  =>  (1===get_magic_quotes_runtime())?'YES':'NO',
        'magic_quotes_runtime'  =>  ("1"===get_cfg_var('magic_quotes_runtime'))?'YES':'NO',
    ...
    public function huifu(){
        ...
        return view('admin/huifu', compact('data'));
    }
    ...
    public function huifu_zn(){
        ...
        return view('admin/huifu_zn', compact('data'));
    }
    ...
    public function huifu_bq(){
        ...
        return view('admin/huifu_bq', compact('data'));
    }
    ...
    public function shangpin(){
        ...
        return view('admin/shangpin', compact('data'));
    }
    ...
    public function shangpin_gid(){
        ...
        $data['url'] = config('app.app_url');//获取网站域名
        
        $data['shangpin_gid']=Db::table('shangpin_gid')->select();

        return view('admin/shangpin_gid', compact('data'));
    }
    ...
    */
    ...
    public function update_img(){
        ...
        $imagePath = public_path('storage').'fengmian_img';

        $ext = $upload->getOriginalExtension();

        $newName = $upload->md5().'.'.$ext;
        
        $info = $upload->move($imagePath,$newName);
    
        if(!in_array($ext,array('jpg','png','gif','jpeg'))){
            exit(json_encode(array('code'=>1,'msg'=>'文件格式错误')));
        } 

        $img = '/fengmian_img/'.$newName; //获取文件路径
    ...
    public function update_shangpinimg(){
        ...
        $imagePath = public_path('storage').'shangpin_img';
        ...
        $img = '/shangpin_img/'.$newName; //获取文件路径
